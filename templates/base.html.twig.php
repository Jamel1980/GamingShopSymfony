...
<section>
    ...
    <section id="body_section">
        <div class="heading_page">
            <div class="container_carousel">
                <div class="width_carousel">
                    ...
                    <b><p class=text-bluegaming>Votre boutique référence, les dernières tendances gaming, accessoires, jeux, espace geek...</p></b>
                </div> 
            </div>
        <!-----------------------------carousel----------------------------->
            <div class="container_carousel">
        ...
        <div> 
            <div class="titrebest">MEILLEURES VENTES</div>
            <div class="containers w-100">
                <div class="containers_carrousels">
                    <div class="card_primary">
                        <img src="public/image-site-vitrine/thelastofusps5.jpeg" class="card-img-top" alt="...">
                        <div class="card_body">
                        <h5 class="card-titre">THE LAST OF US</h5>
                        <p class="card-texte">La survie à tout prix. Redécouvrez le jeu qui a conquis le cœur des joueurs et avec lequel tout a commencé, recréé pour la console PlayStation®5
                       </p>
                        <a href="" class="buttun buttun-primary text-primary">PLUS D'INFORMATIONS</a>
                        </div>
                    </div>
                    <div class="card_primary">
                        <img src="public/image-site-vitrine/PS5-copie.jpg" class="card-img-top" alt="...">
                        <div class="card_body">
                        <h5 class="card-titre">PS5</h5>
                        <p class="card-texte">Plongez dans le futur univers du gaming avec la nouvelle PS5 standard ou la Playstation 5 Digital Edition d'un design à couper le souffle!</p>
                        <a href="#" class="buttun buttun-primary text-primary ">PLUS D'INFORMATIONS</a>
                        </div>
                    </div>
                    <div class="card_primary">
                        <img src="public/image-site-vitrine/halo-infinite-photo.jpg" class="card-img-top" alt="...">
                        <div class="card_body">
                        <h5 class="card-titre">HALO INFINITE</h5>
                        <p class="card-texte">La légendaire série Halo est de retour. Découvrez la plus vaste campagne Master Chief jamais proposée et vivez une expérience multijoueur gratuite.</p>
                        <a href="#" class="buttun buttun-primary text-primary">PLUS D'INFORMATIONS</a>
                        </div>
                    </div>
                    <div class="card_primary">
                ...
                <div class="titrebest2">NOUVEAUTES</div>
                <div class="containers_carrousels">
                    <div class="card_primary">
                        <img src="public/image-site-vitrine/pack-xbox.jpeg" class="card-img-top" alt="...">
                        <div class="card_body">
                        <h5 class="card-titre">PACK XBOX SERIES X</h5>
                        <p class="card-texte">Microsoft Xbox Series X. Plateforme: Xbox Series X, Couleur du produit: Noir, Mémoire interne: 16384 Mo. Supports de stockage: SSD.</p>
                        <a href="#" class="buttun buttun-primary text-primary">PLUS D'INFORMATIONS</a>
                        </div>
                    </div>
                    <div class="card_primary">
                        <img src="public/image-site-vitrine/mario_kart_8.jpeg" class="card-img-top" alt="...">
                        <div class="card_body">
                        <h5 class="card-titre">MARIO KART 8</h5>
                        <p class="card-texte">Mario et toute son équipe vous attendent pour de nouvelles aventures sur nintendo. Le multijoueur par excellence, seul ou avec des amis.</p>
                        <a href="#" class="buttun buttun-primary text-primary">PLUS D'INFORMATIONS</a>
                        </div>
                    </div>
                    <div class="card_primary">
                        <img src="public/image-site-vitrine/Fifa24.jpg" class="card-img-top" alt="...">
                        <div class="card_body">
                        <h5 class="card-titre">FIFA 24</h5>
                        <p class="card-texte">Retrouvez le best-seller de jeux de football. Tous les meilleurs joueurs du monde et les plus grandes équipes vous attendent.</p>
                        <a href="#" class="buttun buttun-primary text-primary">PLUS D'INFORMATIONS</a>
                        </div>
                    </div>
                    <div class="card_primary">
